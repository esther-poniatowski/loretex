...
logic is modular and supports extensibility across formatting features.

Modules
-------
loretex.parsers.markdown_converter
    Functions for converting Markdown strings into LaTeX-formatted output.
"""
